  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-lg">
            <h2 className="text-lg font-semibold text-gray-900">Otras Especialidades</h2>
            <p className="text-sm text-gray-600 mt-1">Selecciona las especialidades adicionales que ofrece el negocio</p>
          </div>
          <div className="p-6">
