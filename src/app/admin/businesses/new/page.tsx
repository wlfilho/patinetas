...
export default function NewBusinessPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const businessData: Omit<NegocioDirectorio, 'id' | 'fecha_creacion' | 'fecha_actualizacion'> = {
        ...formData,
      ...
      await adminService.createBusiness(businessData)
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Agregar Nuevo Negocio</h1>
        <p className="text-gray-600">Completa la información del negocio para agregarlo al directorio</p>
      </div>
